...
class XXLJOBPOC(POCBase):
    ...
    def _check(self):
        ...
        result = []
        try:
            res = requests.post(url=url, headers=headers, allow_redirects=False,  verify=False, timeout=5)
            # 判断是否存在漏洞
